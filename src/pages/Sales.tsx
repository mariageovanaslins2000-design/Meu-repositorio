      ...
      <header className="border-b bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src={logoDark} alt="iClinic" className="h-10 w-10 object-contain" />
            <span className="font-display text-xl font-semibold">iClinic</span>
          </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-lg p-6 border">
              <h3 className="font-semibold mb-2">Como funciona a integração com WhatsApp?</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-card rounded-lg p-6 border">
              <h3 className="font-semibold mb-2">Preciso instalar algo?</h3>
              <p className="text-muted-foreground">
